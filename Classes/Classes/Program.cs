...
namespace Classes
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Dave's age is {0} he started on {1} and makes {2}", Dave.Age, Dave.StartingDate,
                Dave.Salary);
            Dave.Bonus(0.05);
            Console.WriteLine("Dave's age is {0} he started on {1} and makes {2}", Dave.Age, Dave.StartingDate,
                Dave.Salary);
            
            Employee Mary = new Employee(25, "Mary Jones", 60000.00, new DateTime(2010,
                2,28), "212-555-1212" );
            Console.WriteLine("\n\nMary's age is {0} she started on {1} and makes {2}", Mary.Age, Mary.StartingDate,
                Mary.Salary);
        }
    }
}